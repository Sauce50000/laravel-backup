<div class="flex flex-col mx-5">
    ...
    <div class="flex" style="background-image: url('{{ asset('images/background/banner_background.jpg') }}');">
        ...
        <div class="w-1/6 flex justify-center items-center">
            <img src="{{ asset('images/logo/flag_nepal.gif') }}" alt="Nepal Flag" class="w-24">
        </div>
    </div>
