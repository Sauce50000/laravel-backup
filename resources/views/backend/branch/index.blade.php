...
@section('content')
    ...
    <div class="container mx-auto py-6">
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-2xl font-semibold text-gray-700">Branch</h2>
        ...
        <table class="min-w-full divide-y divide-gray-200 text-sm">
            ...
            <tbody class="divide-y divide-gray-100">
                @foreach ($branches as $branch)
                    <tr class="{{ $branch->deleted_at ? 'bg-red-300' : 'bg-white' }}">
                        <td class="px-4 py-2">{{ $branch->iteration+1 }}</td>
                        <td class="px-4 py-2">{{ $branch->title }}</td>
                        <td class="px-4 py-2">{{ $branch->title_en }}</td>
