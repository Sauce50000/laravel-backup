...
@section('title', 'Edit Notice Type')

@section('content')
    <div class="container mx-auto py-8">
        <h1 class="text-3xl font-bold text-gray-800 mb-6">Edit Notice Type</h1>

        <form action="{{ route('record-types.update', $recordType->id) }}" method="POST"
            ...
            <div class="mb-6 w-full">
                ...
                <input type="text" name="title" id="title" required
                    value="{{ old('title', $recordType->title) }}"
            ...
            <div class="mb-6 w-full">
                ...
                <input type="text" name="title_en" id="title_en"
                    value="{{ old('title_en', $recordType->title_en) }}"
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200"
            ...
            <div class="mb-6 w-full">
                ...
                <input type="text" name="slug" id="slug" value="{{ old('slug', $recordType->slug) }}"
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200"
                    placeholder="Auto-generated slug" x-data="{ slug: '{{ old('slug', $recordType->slug) }}' }" x-init="generateSlug()"
